<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentLogin.aspx.cs" Inherits="StudentLogin" EnableEventValidation="false" %>
...
<!--===============================================================================================-->
 ...
 <body>
  ...
  <div class="limiter">
		<div class="container-login100" style="background-image:url('GIFs/studentLogin2.gif'); background-size:cover;">
			...
			<div class="wrap-login100" style="background-color:rgba(255, 255, 255, 0.3);">
				...
				<form class="login100-form validate-form" runat="server">
					...
					<div class="container-login100-form-btn">
                        <asp:Button ID="btnSignin" runat="server" Text="Login" CssClass="login100-form-btn" OnClick="btnSignin_Click" />
