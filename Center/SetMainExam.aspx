<%@ Page Title="" Language="C#" MasterPageFile="~/Center/CenterAdminMasterPage.master" AutoEventWireup="true" CodeFile="SetMainExam.aspx.cs" Inherits="Center_SetMainExam" %>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                           <div class="row mt-3" style="font-size:15px;">
                            ...
                            <div class="col-9" >
                                ...
                                <asp:GridView ID="gvStudents" runat="server" Width="100%" DataKeyNames="ID" AutoGenerateColumns="false" GridLines="Both" CssClass="table rounded-corners" 
                        style= "-moz-border-radius: 25px;border-radius: 25px;" HeaderStyle-CssClass="table-sm bg-dark" RowStyle-CssClass="bg-info" AlternatingRowStyle-CssClass="table-secondary">
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkSelect" runat="server" OnCheckedChanged="chkSelect_CheckedChanged" AutoPostBack="true" CommandArgument='<%# Eval("ID") %>'/>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                        ...
                        <div class="row mt-3" style="font-size:15px;">
                            <div class="col-3"><asp:Label ID="lblExammode" runat="server" Text="Select Exam Mode"></asp:Label>
                    ...
                    <div class="row mt-2 mb-3">
                        ...
                        AlternatingRowStyle-CssClass="table-secondary" HeaderStyle-HorizontalAlign="Center" Width="100%" CellPadding="3" OnRowDeleting="gvCenter_RowDeleting">
                                        ...
                                        <Columns>
                                          ...
                                          <%--  <asp:TemplateField HeaderText="Question Paper">
                                            ...
                                            <asp:TemplateField HeaderText="Delete">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lbRemove" runat="server" Text="Remove" CommandName="Delete" OnClientClick="return confirmDel();"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
