<%@ Page Title="" Language="C#" MasterPageFile="~/Center/CenterAdminMasterPage.master" AutoEventWireup="true" CodeFile="Student.aspx.cs" Inherits="Center_Student" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script>
        //$(document).ready(function () {
            ...
            //document.getElementsByID("txtsessionfrom")[0].setAttribute('min', today);
