<%@ Page Title="" Language="C#" MasterPageFile="~/Center/CenterAdminMasterPage.master" AutoEventWireup="true" CodeFile="EditCourse.aspx.cs" Inherits="Center_EditCourse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="container">
        ...
        <div class="row mt-4">
            <div class="col-3"></div>
            <div class="col-8 ml-4">
                <asp:Button ID="btnupdatecourse" CssClass="btn btn-primary btn-block" runat="server" Text="update" OnClick="btnupdatecourse_Click"/>
            </div>
        </div>
    </div>
</asp:Content>
