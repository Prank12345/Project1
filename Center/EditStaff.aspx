<%@ Page Title="" Language="C#" MasterPageFile="~/Center/CenterAdminMasterPage.master" AutoEventWireup="true" CodeFile="EditStaff.aspx.cs" Inherits="Center_EditStaff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row mt-2">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <asp:Button ID="btnsubmit" CssClass="form-control btn-primary" runat="server" Text="Update" OnClick="btnsubmit_Click"  />
            </div>
        </div>
