<%@ Page Title="" Language="C#" MasterPageFile="~/Center/CenterAdminMasterPage.master" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="Center_Dashboard" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row" id="dd" runat="server">    
            ...
            <div class="small-box bg-primary">
              <div class="inner">
               ...
               <div class="icon">
                ...
                <p>Students</p>
                   <h4><asp:Label ID="lblstudent" runat="server" Text="student"></asp:Label></h4>
              </div>
            ...
            <div class="small-box bg-gradient-fuchsia">
             ...
             <a href="ManageCourse.aspx" class="small-box-footer">Details <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
             <div class="col-lg-4 col-6">
            <!-- small box -->
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <p>My Wallet</p>
                <h4><asp:Label ID="lblmoney" runat="server" Text=""></asp:Label></h4>
              </div>
              <a href="eWallet.aspx" class="small-box-footer">Details<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
