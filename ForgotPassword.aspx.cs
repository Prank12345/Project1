...
public partial class FrogotPassword : System.Web.UI.Page
{
    ...
    public string contact()
    {
        ...
        pram.Add(new SqlParameter("@CenterID", txtid.Text));
        string strGetData = DBT.P_returnOneValue("select Password from CenterRegistration where Email=@Email and CenterID=@CenterID",pram); 
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        List<SqlParameter> pram = new List<SqlParameter>();
        pram.Add(new SqlParameter("@Email", vEmail));
        pram.Add(new SqlParameter("@CenterID", vCenterID));
        string strGetData = "select * from CenterRegistration where Email=@Email and CenterID=@CenterID";
