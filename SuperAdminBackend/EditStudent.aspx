<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdminBackend/SuperAdminMasterPage.master" AutoEventWireup="true" CodeFile="EditStudent.aspx.cs" Inherits="SuperAdminBackend_EditStudent" %>
    ...
    <div class="container-fluid">
         ...
         <div class="row mt-2">
            ...
            <div class="col-4">
             ...
             <div class="col-4">
                ...
                <asp:textbox ID="txtTotSem" CssClass="form-control" runat="server"></asp:textbox>
            </div>
        </div>
        ...
        <div class="row mt-2">
            ...
            <div class="col-4">
                ...
                <asp:textbox ID="txtRegisFees" placeholder="Enter Course Fee" CssClass="form-control" runat="server"></asp:textbox>
            </div>
             <div class="col-4">
                <asp:label  runat="server" text="Exam Fees for full course"></asp:label>
                <asp:textbox ID="txtExamFees" placeholder="Enter Course Fee" CssClass="form-control" runat="server"></asp:textbox>
            </div>
        </div>
        <div class="row mt-2">
            <div class="col-6">
         ...
         <div class="row mt-2">
            ...
            <div class="col-5">
                ...
                <asp:textbox ID="txtsname" placeholder="Enter Student Name" cssclass="form-control" runat="server"></asp:textbox>
            </div>
        
            <div class="col-5">
                <asp:label  runat="server" text="Father/Husband Name"></asp:label>
                <asp:textbox ID="txtfhname"  placeholder="Enter Father/Husband Name" cssclass="form-control" runat="server"></asp:textbox>
            </div>
        </div>
         <div class="row mt-2">
              <div class="col-6">
                <asp:label  runat="server" text="Mother Name"></asp:label>
                <asp:textbox ID="txtMName"  placeholder="Mother Name" cssclass="form-control" runat="server"></asp:textbox>
            </div>
            <div class="col-6">
        ...
        <div class="row mt-2">
            ...
            <div class="col-6">
                ...
                <asp:TextBox ID="txtEmergency"  placeholder="Enter Emergency Number" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
            </div>
         <div class="row mt-2">
              <div class="col-6">
                <asp:label  runat="server" text="Father Occupation"></asp:label>
                <asp:textbox ID="txtFOccupation"  placeholder="Father Occupation" cssclass="form-control" runat="server"></asp:textbox>
            </div>
            <div class="col-6">
                <asp:Label ID="lblStuOccupation" runat="server" Text="Student Occupation"></asp:Label><br />
               <asp:textbox ID="txtSOccupation"  placeholder="Student Occupation" cssclass="form-control" runat="server"></asp:textbox>
            </div>
        </div>
         <div class="row mt-2">
              <div class="col-6">
        ...
        <div class="row mt-2">
            ...
            <div class="col-6">
                ...
                <asp:DropDownList ID="ddid" CssClass="form-control" runat="server">
            ...
            <div class="col-6">
                ...
                <asp:TextBox ID="txtidnum" placeholder="Enter ID Number" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
        </div>
        <div class="row mt-2">
            ...
            <div class="col-6">
                ...
                <asp:TextBox ID="txtphone" TextMode="Number"  placeholder="Enter Phone Number" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
        
            <div class="col-6">
                <asp:Label ID="lblemail" runat="server" Text="Student Email"></asp:Label>
                <asp:TextBox ID="txtemail"  placeholder="Enter Email Address" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
        </div>
        <div class="row mt-2">
            ...
            <div class="col-12">
               ...
               <div class="col-6 mt-2">
                    <span>From-</span>
                <asp:TextBox ID="txtsessionfrom" CssClass="form-control" TextMode="Date" runat="server"></asp:TextBox>
                    </div>
                 <div class="col-6 mt-2">
                     <span>To-</span>
                <asp:TextBox ID="txtsessionto" CssClass="form-control" TextMode="Date" runat="server"></asp:TextBox>
                    </div>
            ...
            <div class="row mt-5">
                <div class="col-6">
                    ...
                    <asp:Image ID="imgStuimg" runat="server" style="width:100px;height:100px;" /><br />
                    <asp:FileUpload ID="fustdimg" runat="server" /><br />
                     <asp:Label ID="lblStuImg" runat="server"></asp:Label>
                ...
                <div class="col-6">
                    ...
                    <asp:Image ID="imgMarksheet" runat="server" style="width:100px;height:100px;" /><br />
                    <asp:FileUpload ID="fumarkst" runat="server" /><br />
         ...
         <div class="row mt-5">
                ...
                <div class="col-6">
                    <asp:Label ID="lblidimage" runat="server" Text="ID Image"></asp:Label><br />
                     <asp:Image ID="imgID" runat="server" style="width:100px;height:100px;" /><br />
                    <asp:FileUpload ID="fuidimage" runat="server" /><br />
                   
                    <asp:Label ID="lblidImg" runat="server"></asp:Label>
                    <span style="font-size:12px;">make sure image is in .jpg , png or jpeg format and must be under 500kb</span>
                </div>
                <div class="col-6">
                    <asp:Label ID="lblpaymnt" runat="server" Text="Payment screenshot"></asp:Label><br />
                    <asp:Image ID="imgPay" runat="server" style="width:100px;height:100px;" /><br />
                    <asp:FileUpload ID="fupscreen" runat="server" /><br />
                     <asp:Label ID="lblPayScreen" runat="server"></asp:Label>
                    <span style="font-size:12px;">make sure image is in .jpg , png or jpeg format and must be under 500kb</span>
                </div>
              </div>
        <div class="row mt-2">
