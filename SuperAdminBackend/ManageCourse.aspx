<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdminBackend/SuperAdminMasterPage.master" AutoEventWireup="true" CodeFile="ManageCourse.aspx.cs" Inherits="SuperAdminBackend_ManageCourse" %>
                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-4 col-sm-4" style="text-align:right;">
                                <a href="AddCourse.aspx" class="btn btn-info">Add Course +</a>
                            </div>
                            <!-- /.col -->
                        </div>
                        <!-- /.row -->
                                ...
                                <div style="width: 99%; overflow: scroll;">
                                    <asp:GridView ID="gvCenter" runat="server" DataKeyNames="ID" AutoGenerateColumns="False" HeaderStyle-Wrap="false"
                                        HeaderStyle-HorizontalAlign="Center" Width="100%" CellPadding="8" BorderStyle="Solid" BorderWidth="2px"
                                         OnRowDataBound="gvCenter_RowDataBound" OnRowDeleting="gvCenter_RowDeleting">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="DetailsOfCourse" HeaderText="Details of Course" />
                                            <asp:BoundField DataField="Subject1" HeaderText="Subject 1" />
                                            <asp:BoundField DataField="Subject2" HeaderText="Other All Subjects" />
                                          <asp:TemplateField HeaderText="Edit">
                                              <ItemTemplate>
                                                  <asp:HyperLink ID="hlEdit" Text="Edit" runat="server" NavigateUrl='<%#"EditCourse.aspx?CID="+Eval("id") %>'></asp:HyperLink>
                                              </ItemTemplate>
                                          </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Edit">
                                              <ItemTemplate>
