...
public partial class SuperAdminBackend_ManageCenters : System.Web.UI.Page
{
    string Password = "";
    ...
    protected void ddlVerification_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            string updateDisplay = "Update CenterRegistration Set isrequest = @isrequest Where ID = @ID";
            List<SqlParameter> Pram = new List<SqlParameter>();
        ...
        if (ddl.SelectedValue == "1")
        {
            ...
            string updateDisplay = "Update CenterRegistration Set isrequest = @isrequest,Password=@Password,VerifyDate=@VerifyDate,RenewalDate=@RenewalDate Where ID = @ID";
            List<SqlParameter> Pram = new List<SqlParameter>();
            Pram.Add(new SqlParameter("@isrequest", "1"));
            Pram.Add(new SqlParameter("@Password", Password));
            Pram.Add(new SqlParameter("@VerifyDate", vVerifyDate));
            Pram.Add(new SqlParameter("@RenewalDate",vRenwalDate));
            Pram.Add(new SqlParameter("@ID", id));
            DBT.P_ExecuteNonQuery(updateDisplay,Pram);
        ...
        {
            string updateDisplay = "Update CenterRegistration Set isrequest = @isrequest Where ID = @ID" + id;
            List<SqlParameter> Pram = new List<SqlParameter>();
    ...
    public string contact(string id)
    {
        ...
        returnString = returnString + "</td>";
        returnString = returnString + "</tr>";
        returnString = returnString + "<tr><td colspan='3' style='margin-top:20px;'><a href='http://www.npcvb.com/CenterLogin.aspx' style='color:white; font-family:Arial; border:solid 1px #3bcefe; padding:10px; margin-left:400px;margin-right:400px; background-color:#0ac3c8;text-decoration:none;'>Click Here To Login </a></td></tr>";
        returnString = returnString + "</tr>";
        returnString = returnString + "<tr>";
    ...
    public string contactR(string id)
    {
        ...
        returnString = returnString + "<p style='color:red;padding-left:200px; font-family:Arial;'>Hello, <b>" + ds.Tables[0].Rows[0]["PersonName"].ToString() + "</b></p>";
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = DBT.P_returnDataSet(Get,Pram);
        SendMailR(ds.Tables[0].Rows[0]["Email"].ToString(), "NPCVBSkillDevelopment", hf.Value);
