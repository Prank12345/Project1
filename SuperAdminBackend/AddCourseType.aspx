<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdminBackend/SuperAdminMasterPage.master" AutoEventWireup="true" CodeFile="AddCourseType.aspx.cs" Inherits="SuperAdminBackend_AddCourseType" %>
                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-lg-12 col-sm-12 mb-2">
                                <h1 class="m-0">Course Type</h1>
                            </div>
                           
                        </div>
                        <div class="row mb-2">
                            <div class="col-lg-12 col-sm-12 mb-2" style="text-align:center">
                                <h4 class="m-0">Add Course Type</h4>
                            </div>
                                    ...
                                    <asp:GridView ID="gvCenter" CssClass="table rounded-corners" style= "-moz-border-radius: 25px;border-radius: 25px;" 
                                        ...
                                        <Columns>
                                           ...
                                           <asp:TemplateField HeaderText="Image">
                                                <ItemTemplate>
                                                   <asp:HyperLink target="_blank" NavigateUrl='<%# "~/CourseTypeImage/" + Eval("ImageUpload") %>' runat="server" ><asp:Image ID="imgPic" runat="server" ImageUrl='<%# "~/CourseTypeImage/" + Eval("ImageUpload") %>' style="width:150px;height:170px;" /></asp:HyperLink>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Edit">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="hlEdit" runat="server" NavigateUrl='<%#"EditCourseType.aspx?CTID="+Eval("ID") %>' CssClass="btn btn-warning"> <i class="fa fa-edit"></i></asp:HyperLink>
                                                </ItemTemplate>
                                            </asp:TemplateField>
