<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdminBackend/SuperAdminMasterPage.master" AutoEventWireup="true" CodeFile="AddSubjQuesMain.aspx.cs" Inherits="SuperAdminBackend_AddSubjQuesMain" %>
                                        ...
                                        <asp:GridView ID="gvaddquestion" runat="server" CssClass="Grid" Width="100%" DataKeyNames="id" CellPadding="8" ForeColor="#333333" 
                                            ...
                                            <Columns>
                                               ...
                                               <asp:TemplateField HeaderText="Edit">
                                                   <ItemTemplate>
                                                       <asp:HyperLink ID="hledit" runat="server" NavigateUrl='<%#"EditSubQues.aspx?EID="+ Eval("ID") %>' CssClass="btn btn-warning"><i class="fas fa-edit"></i></asp:HyperLink>
                                                   </ItemTemplate>    
                                               </asp:TemplateField>
