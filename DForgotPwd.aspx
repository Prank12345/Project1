<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DForgotPwd.aspx.cs" Inherits="DForgotPwd" %>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="../../index3.html" method="post" runat="server">
        ...
        <asp:TextBox ID="txtid" CssClass="form-control" required placeholder="Distributor ID" runat="server"></asp:TextBox>
        ...
        <div class="input-group mb-3">
            ...
            <asp:TextBox ID="txtemail" CssClass="form-control" required placeholder="EmailID" runat="server"></asp:TextBox>
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-envelope"></span>
            </div>
