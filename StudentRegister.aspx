<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMasterPage.master" AutoEventWireup="true" CodeFile="StudentRegister.aspx.cs" Inherits="StudentRegister" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="row">
            ...
            <div class="col-12 mt-3 pt-5 pb-5 text-center" style="font-size:30px; background-image:url('../Image/slider1.jpg'); background-repeat:no-repeat; background-size:cover; width:100%;">
    ...
    $(function () {
        ...
        $('[id*=txtsessionfrom]').attr('min', date);
    });
</script>
</asp:Content>
